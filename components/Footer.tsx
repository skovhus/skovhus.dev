  ...
  return (
    ...
    >
      <div className={styles.footerInner}>
        ...
        <ExternalLink href="https://x.com/kenneth_skovhus">
          <SvgIcon
            viewBox="0 0 16 16"
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            strokeMiterlimit="1.414"
            role="img"
            aria-label="x.com/kenneth_skovhus"
          >
            <path
        ...
        <ExternalLink href="/feed">
          <SvgIcon viewBox="-4 -4 32 32" role="img" aria-label="RSS feed">
            <path d="M19.199 24C19.199 13.067 10.933 4.8 0 4.8V0c13.165 0 24 10.835 24 24h-4.801zM3.291 17.415c1.814 0 3.293 1.479 3.293 3.295 0 1.813-1.485 3.29-3.301 3.29C1.47 24 0 22.526 0 20.71s1.475-3.294 3.291-3.295zM15.909 24h-4.665c0-6.169-5.075-11.245-11.244-11.245V8.09c8.727 0 15.909 7.184 15.909 15.91z" />
          </SvgIcon>
        </ExternalLink>
      </div>
...
function SvgIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" className={styles.svgIcon}>
      {props.children}
    </svg>
  )
}
